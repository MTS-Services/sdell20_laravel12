    ...
    return (
        <header className="sticky top-0 z-50">
            ...
            <div className="bg-slate-500 py-2 text-center">
                <p className="px-4 font-serif text-base tracking-wide text-white lg:text-xl">
                    <span className="">
            ...
            <nav className="w-full bg-primary-700">
                <div className="container mx-auto flex items-center justify-between px-4 lg:px-6">
                    ...
                    <div className="flex items-center lg:hidden">
                        ...
                        <Link
                            href={route('lpa.start')}
                            className="group hidden items-center gap-1 rounded-full bg-slate-500 py-1.5 pr-1.5 pl-3 transition-all hover:bg-slate-600 sm:flex"
                        >
                            <span className="flex flex-col leading-tight text-white">
                    ...
                    <div className="fixed inset-0 z-50 flex flex-col bg-primary-600 lg:hidden">
                        ...
                        <div className="flex-1 overflow-y-auto px-4 pt-2 pb-8">
                            ...
                            <div className="mt-6 space-y-3">
                                ...
                                >
                                    <span>
                                        Create Your LPA &ndash; &pound;99 + VAT
                                        each
                                    </span>
                                    <ChevronRight className="h-4 w-4" />
                                </Link>
