        ...
        <footer className="bg-slate-900 text-white py-16">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 pl-14 sm:pl-0">
                <div className="grid gap-12 mb-12  grid-cols-1 lg:grid-cols-3">
                    ...
                    <div className="space-y-4 text-center md:text-left">
                        ...
                        <div className="flex flex-wrap justify-center gap-4 pt-4 md:justify-start">
                            ...
                            <a href="#" className="hover:text-primary-300 transition-colors" aria-label="LinkedIn">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <a
                            href={route('contact')}
                            className="inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 font-semibold text-primary-900 transition hover:-translate-y-0.5 hover:bg-slate-100"
                        >
                            Contact us today
                ...
                <div className="border-t border-slate-800 pt-8 mt-8">
                    <div className="flex flex-col items-center justify-between gap-4 text-center text-sm text-primary-300 md:flex-row md:space-y-0 md:text-left">
                        <p>
