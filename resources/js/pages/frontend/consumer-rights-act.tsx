                ...
                <section className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto">
                        <div className="mb-12 text-center">
                            <p className="text-sm uppercase tracking-[0.4em] text-primary-400">Consumer Rights</p>
                            <h1 className="mt-4 text-4xl font-serif font-semibold text-primary-900">How we comply with the Consumer Rights Act 2015</h1>
