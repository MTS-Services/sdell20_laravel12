                ...
                <section className="container mx-auto px-6">
                    <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
                        <div className="space-y-10">
                            <header className="rounded-4xl bg-white/90 p-8 shadow-[0_25px_60px_rgba(15,23,42,0.08)]">
                                <p className="text-xs font-semibold uppercase tracking-[0.5em] text-primary-400">Cookie Policy</p>
                                <h1 className="mt-4 text-4xl font-serif font-semibold text-primary-900">Cookies that keep your online will journey smooth</h1>
                            ...
                            <section className="rounded-4xl border border-primary-100 bg-white/80 p-8">
                                <h2 className="text-2xl font-semibold text-primary-900">Cookie categories</h2>
                                <div className="mt-6 grid gap-6 md:grid-cols-2">
                                    {cookieHighlights.map((item) => (
                                        <div key={item.title} className="rounded-3xl border border-slate-200/80 bg-slate-50/60 p-5">
                                            <p className="text-sm uppercase tracking-[0.3em] text-primary-400">{item.title}</p>
                                            <p className="mt-3 text-base leading-relaxed text-primary-700">{item.detail}</p>
                                        </div>
                                    ))}
                                </div>
                            </section>

                            <section className="rounded-4xl bg-primary-900 p-8 text-white">
                                <div className="flex flex-col gap-6 md:flex-row md:items-center">
                                    <div className="md:w-2/3">
                                        <h2 className="text-3xl font-semibold">Managing preferences</h2>
                        ...
                        <aside className="space-y-6">
                            <div className="rounded-4xl bg-white p-7 shadow-[0_20px_55px_rgba(15,23,42,0.08)]">
                                <h3 className="text-xl font-semibold text-primary-900">At-a-glance</h3>
                                <ul className="mt-4 space-y-4 text-base text-primary-700">
                                    {quickFacts.map((fact) => (
                            ...
                            <div className="rounded-4xl border border-slate-200 bg-white/90 p-7">
                                <h3 className="text-xl font-semibold text-primary-900">Third-party tools</h3>
                            ...
                            <div className="rounded-4xl border border-primary-100 bg-primary-50 p-7">
                                <h3 className="text-xl font-semibold text-primary-900">Retention policy</h3>
                                <p className="mt-3 text-base leading-relaxed text-primary-700">
