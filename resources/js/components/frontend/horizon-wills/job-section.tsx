                    ...
                    >
                        ...
                        <div className="flex flex-col gap-4 sm:flex-row sm:justify-center lg:justify-start">
                            <button
                                ...
                                className="inline-flex items-center border border-primary-500 justify-center gap-2 rounded-full bg-brand-cta px-8 py-3 text-sm font-semibold text-white shadow-md transition hover:bg-brand-cta-hover disabled:opacity-50 disabled:cursor-not-allowed"
                            >
