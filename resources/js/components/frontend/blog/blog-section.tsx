            ...
            {lastPage > 1 && (
                <div className="mt-8 flex justify-center items-center space-x-2">
                    ...
                    <button
                        onClick={() => changePage(currentPage + 1)}
                        disabled={!hasNext}
                        className="px-3 py-2 text-sm font-medium text-white bg-brand-cta border cursor-pointer border-transparent rounded-md hover:bg-brand-cta-hover font-ubuntu disabled:opacity-40 disabled:cursor-not-allowed"
                    >
                        Next
                    </button>
                </div>
