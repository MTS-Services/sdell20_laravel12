    ...
    return (
        <section className="px-4 py-16 sm:px-6 lg:px-10">
            <div className="mx-auto max-w-5xl text-center">
                <h3 className="text-3xl font-serif font-semibold text-slate-900 animate-fadeInUp">Helping you make the right choice</h3>
                <div className="mt-10 divide-y divide-slate-200 rounded-3xl border border-slate-100 bg-white text-left">
                    {faqItems.map((question, index) => (
                        <button
                            ...
                            className="flex w-full items-center justify-between px-6 py-5 text-left text-sm font-semibold text-slate-900 transition hover:bg-primary-50"
                        >
                            <span>{question}</span>
