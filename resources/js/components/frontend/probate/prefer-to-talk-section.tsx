        ...
        <section className="bg-white py-20 px-4">
            <div className="max-w-6xl mx-auto">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        <h2 className="text-4xl font-bold text-gray-900 mb-6">Prefer to talk?</h2>
                        ...
                        <div className="bg-slate-100 border-2 border-slate-400 rounded-xl p-4 mb-4">
                            <p className="font-semibold text-gray-900 mb-2">We&apos;re here to help</p>
                            <button
                                className="btn-slate px-6 py-3 rounded-lg font-semibold inline-flex items-center gap-2 w-full justify-center">
