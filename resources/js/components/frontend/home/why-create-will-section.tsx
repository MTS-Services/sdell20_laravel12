    ...
    return (
        <section className="py-24 bg-white overflow-hidden">
            <div className="container mx-auto px-6">
                ...
                <div ref={gridRef} className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
                    {cards.map((card) => (
                        <div
                            key={card.title}
                        ...
                        >
                            <div
                                className={`w-24 h-24 bg-white rounded-2xl mx-auto mb-6 flex items-center justify-center shadow-md transition-all duration-500 group-hover:scale-125 group-hover:rotate-6 group-hover:shadow-xl group-hover:-translate-y-2`}
                            >
