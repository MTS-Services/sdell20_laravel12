...
const lpaStats: StatBlock[] = [
    {
        value: '50,000',
        title: 'LPAs contain mistakes every year',
        lead: 'Why do so many LPA applications go wrong?',
        paragraphs: [
            'Many try to complete LPA forms directly through the .Gov.UK website without guidance.',
            'Small errors like signing in the wrong order or writing unclear instructions can cause rejections or delays.',
            'We guide you through each step so you can complete your LPA with confidence.',
        ],
    },
    {
        value: '10x',
        title: 'faster than using a solicitor',
        lead: 'Skip the appointments and paperwork',
        paragraphs: [
            'Traditional solicitor services often involve meetings, letters and weeks of waiting.',
            'With Power of Attorney Online you can complete your LPA forms online in around 15 minutes, from home, at your own pace.',
            'No appointments. No delays.',
        ],
    },
    {
        value: '80%',
        title: 'more affordable than solicitors',
        lead: 'Professional guidance without the high fees',
        paragraphs: [
            'Solicitors often charge up to £1000 to prepare Lasting Powers of Attorney.',
            'Power of Attorney Online can cost up to 80% less, while still guiding you through the same legal documents.',
    ...
    },
    {
        ...
        lead: 'Start today, finish when it suits you',
        paragraphs: [
            'You can complete your LPA application online at any time.',
            'Power of Attorney Online is available 24 hours a day.',
            'There are no office hours and no appointments. Start, pause and return whenever you like.',
        ],
    },
];
...
const bannerContent: Record<BannerVariant, BannerContent> = {
    lpa: {
        ...
        h1: 'Get your Lasting Power of Attorney sorted today',
        ...
        bodyParagraphs: [
            ...
            'Power of Attorney Online helps you create legally correct LPA documents in minutes, without the cost or complexity.',
