        ...
        <section className="bg-white px-4 py-10 md:px-6 md:py-14">
            <div className="container mx-auto max-w-7xl">
                <div className="rounded-3xl border border-slate-200 bg-slate-100 p-8 shadow-sm md:p-10 lg:p-12">
                    ...
                    <div className="mx-auto mt-10 max-w-4xl overflow-hidden rounded-2xl border border-slate-200 bg-primary-900 shadow-lg">
                    ...
                    <div className="mt-10 flex flex-col items-center justify-center gap-6 sm:flex-row sm:flex-wrap sm:gap-8">
