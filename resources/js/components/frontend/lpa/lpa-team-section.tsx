        ...
        <section className="bg-linear-to-b from-primary-100 via-primary-50 to-white py-16">
            <div className="container mx-auto grid gap-10 px-6 lg:grid-cols-2">
                ...
                <div className="animate-fadeInRight">
                    <h2 className="font-display text-3xl text-slate-900">Our job is to bring care to life.</h2>
                    ...
                    <a href="#perks" className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-slate-900">
