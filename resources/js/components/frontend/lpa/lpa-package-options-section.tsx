        ...
        <section className="bg-[#f5f7f2] py-16">
            <div className="max-w-4xl mx-auto px-4">
                <div className="mx-auto mb-12 max-w-2xl text-center">
                    ...
                    <h2 className="mt-3 text-3xl font-semibold text-slate-900">Choose the LPA plan that fits you best</h2>
                </div>
                    ...
                    {packages.map((pkg) => (
                        <div key={pkg.title} className="flex h-full flex-col rounded-[28px] bg-white p-6 shadow-[0_30px_70px_rgba(15,23,42,0.07)]">
                            ...
                            <div className="space-y-2">
                                <p className="text-2xl font-semibold text-slate-900">{pkg.title}</p>
                                <p className="text-sm font-medium text-slate-500">{pkg.subtitle}</p>
                            ...
                            <button
                                type="button"
                                className="mt-auto inline-flex items-center gap-2 rounded-full  px-5 py-2 text-sm font-semibold text-slate-900 transition   hover:scale-105"
                            >
                                Get Started
                                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-slate-900 text-white transition group-hover:bg-white group-hover:text-slate-900">
