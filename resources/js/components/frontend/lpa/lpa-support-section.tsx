        ...
        <section id="support" className="relative overflow-hidden bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 py-20 text-white">
            ...
            <div className="container relative mx-auto grid gap-12 px-6 lg:grid-cols-2">
                ...
                <div>
                    ...
                    <button className="mt-8 inline-flex items-center gap-2 rounded-full bg-white px-8 py-3 text-sm font-semibold text-slate-900 transition hover:-translate-y-0.5 animate-fadeInRight" style={{ animationDelay: '150ms' }}>
                        Speak to our team
