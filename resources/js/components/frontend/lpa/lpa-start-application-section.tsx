...
export function LpaStartApplicationSection() {
    const [sectionRef, sectionVisible] = useReveal<HTMLDivElement>(0.08);

    return (
        <div ref={sectionRef} className="container mx-auto px-4 py-8 md:px-6 md:py-10">
                    ...
                    <div className="px-5 pb-10 pt-10 sm:px-8 md:px-12 md:pb-12 md:pt-12">
                        <RevealMotion show={sectionVisible} mode="fade-up" delayClass="delay-100">
                            <div className="mb-10 text-center md:mb-12">
                                ...
                                Lasting Power of Attorney Forms & Lasting Power of Attorney Application
                                </h1>
                        ...
                        <div className="grid gap-10 lg:grid-cols-2 lg:gap-0">
                            ...
                            >
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-4 md:gap-5">
                                        {readyItems.map(({ title, icon: Icon }, index) => (
                                            <RevealMotion
                                                key={title}
                                                show={sectionVisible}
                                                mode="fade-up"
                                            ...
                                            >
                                                <div className="flex flex-col gap-3 rounded-xl border border-white/10 bg-primary-50/10 p-5 md:p-6">
                            ...
                            <RevealMotion
                                ...
                                className="lg:border-l lg:border-slate-400/35 lg:pl-8 xl:pl-14"
                            >
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-5">
                                        <RevealMotion show={sectionVisible} mode="fade-up" delayClass="delay-100">
                                            <div className="rounded-xl border border-primary-600/60 bg-primary-50/20 p-5 md:p-6">
                                                ...
                                                <p className="mt-4 text-sm leading-relaxed text-primary-100 md:text-base">
                                                    ...
                                                    LPA documents and guide you through the process.
                                                </p>
                                            </div>
                                        </RevealMotion>
                                        <RevealMotion show={sectionVisible} mode="fade-up" delayClass="delay-200">
                                            <div className="rounded-xl border border-primary-600/60 bg-primary-50/20 p-5 md:p-6">
                                                ...
                                                <p className="mt-4 text-sm leading-relaxed text-primary-100 md:text-base">
                                                    This is a government fee paid directly to the Office of the Public Guardian when
                                                    you send your forms for registration.
                                                </p>
                                            </div>
                                        </RevealMotion>
                                    </div>
                                    <RevealMotion show={sectionVisible} mode="fade-up" delayClass="delay-300" className="mt-4 md:mt-5">
                                        <div className="rounded-xl border border-primary-600/60 bg-primary-50/20 px-5 py-4 text-center text-sm leading-relaxed text-primary-100 md:px-6 md:py-5 md:text-base">
                                            You can pay the OPG fee by including a cheque with your forms or by card when they
                                            contact you after receiving your application.
                                        </div>
                                    </RevealMotion>
                                </div>
                            </RevealMotion>
