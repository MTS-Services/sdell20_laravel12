                ...
                <div className="flex min-h-90 items-center py-16 md:min-h-105 md:py-20">
                    <div className="max-w-xl space-y-5 animate-fadeInUp">
                        ...
                        <div className="pt-2">
                            <a
                                href="#contact-form"
                                className="inline-flex items-center justify-center rounded-full bg-brand-cta px-6 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-brand-cta-hover"
                            >
                                Enquire now
                            </a>
                        </div>
