...
<head>
    ...
    <title>Lasting Power of Attorney - Health and Welfare</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="page">
        ...
        <h2 class="subtitle">health and welfare</h2>
        ...
        <div class="section">
            ...
            <!-- Life-Sustaining Treatment Section -->
            <div class="life-sustaining-section">
                <h3 style="font-size: 11pt; margin-bottom: 10px;">Life-sustaining treatment</h3>
                <p style="font-size: 9pt; margin-bottom: 10px;">
                    Life-sustaining treatment is treatment which a doctor considers necessary to keep you alive.
                </p>
                <p style="font-size: 9pt; margin-bottom: 10px;">
                    <strong>Option A:</strong> I want my attorneys to have authority to give or refuse consent to life-sustaining treatment on my behalf.
                </p>
                <p style="font-size: 9pt;">
                    <strong>Option B:</strong> I do not want my attorneys to have authority to give or refuse consent to life-sustaining treatment on my behalf.
                </p>
                <div style="margin-top: 10px;">
                    <div class="checkbox-field">{{ $lpa->life_sustaining_treatment ? '✓' : '' }}</div>
                    <span style="font-size: 9pt;">Option selected: {{ $lpa->life_sustaining_treatment ? 'Option A' : 'Option B' }}</span>
                </div>
            </div>
